...
<table style="width:100%;">
    <tr>
        <td valign="top" style="padding:15px 0 0 25px;">
            <div style="float:left;"><a href="<?=($arResult["PRICE_SORT"] == "ASC")?$arResult["COMPONENT_URL"]."?price_sort=desc":$arResult["COMPONENT_URL"]."?price_sort=asc";?>">Сортировать по цене</a></div>
            <div style="float:left; margin:2px 0 0 7px;"><a href="<?=$arResult["COMPONENT_URL"]."?price_sort=asc"?>"><img src="/images/price_asc.png" width="10" height="10" alt="Сортировать по возрастанию цены" /></a></div>
            <div style="float:left; margin:2px 0 0 2px;"><a href="<?=$arResult["COMPONENT_URL"]."?price_sort=desc"?>"><img src="/images/price_desc.png" width="10" height="10" alt="Сортировать по убыванию цены" /></a></div>
        </td>
        <td valign="top"><?
