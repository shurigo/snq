...
<div style="padding:0 16px 20px 0px;">
    <?if($arParams["DISPLAY_DATE"]!="N" && $arResult["DISPLAY_ACTIVE_FROM"]):?>
        <div style="margin:0 0 20px 0;"><span style="background:#363636; padding:3px 16px; color:#b7b7b7; font-size:10px;"><?echo $arResult["DISPLAY_ACTIVE_FROM"]?> - <?echo $arResult["DISPLAY_ACTIVE_TO"]?></span></div>
    <?endif?>
