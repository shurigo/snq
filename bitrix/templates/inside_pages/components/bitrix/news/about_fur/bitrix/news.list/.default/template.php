...
$APPLICATION->SetPageProperty("title", "Меха от Снежной Королевы. Все виды меха, рекомендации по хранению и уходу за меховыми изделиями.Советы по выбору шубы.");
$APPLICATION->SetPageProperty("keywords", "меха, виды меха,как выбрать шубу, меховые изделия, виды меха, хранение меха,износостойкость меха");
