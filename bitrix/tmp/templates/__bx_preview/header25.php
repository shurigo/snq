...
<script type="text/javascript">
  VK.init({apiId: 2153619, onlyWidgets: true});
</script>
</head>
        ...
        <td style="width:980px;">
            ...
            <table style="width:100%;">
            	<tr>
                    ...
                    <td style="width:25%;"></td>
                    <td style="width:190px;"><a href="/collection/wleather_ss11/"><img src="/images/catalog_menu/leather_clothes.jpg" width="190" height="37" alt="Одежда из кожи" title="Одежда из кожи" /></a></td>
                    <td style="width:25%;"></td>
                    <td style="width:190px;"><a href="/collection/wclothes_ss11/"><img src="/images/catalog_menu/textile_clothes.jpg" width="190" height="37" alt="Одежда из текстиля" title="Одежда из текстиля" /></a></td>
                    <td style="width:25%;"></td>
                    <td style="width:190px;"><a href="/collection/waccessories_ss11/"><img src="/images/catalog_menu/accessories.jpg" width="190" height="37" alt="Сумки и аксессуары" title="Сумки и аксессуары" /></a></td>
                </tr>
            </table>
            </div>
            <div style="margin:10px 0 0 0;">
            	<table style="width:100%;">
                	<tr>
                    	<td style="width:199px;" valign="top">
                        	<div style="width:199px; height:150px; background:url(/images/mainpage_blocks/catalog_ss11.jpg) no-repeat;">
                                <div style="width:199px; height:110px; cursor:pointer;" onclick="window.location='/collection/'"></div>
                                <div style="width:199px; height:52px; padding:6px 0 0 0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/upload/catalog_ss11.pdf" style="font-weight:bold;" class="snq_color">Скачать каталог</a><br />
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PDF, Объём: 4,13 Mb</div>
                            </div>
                            <div style="margin:15px 0 0 0;"><a href="/about/fashion_blog/"><img src="/images/mainpage_blocks/anna_rykova.jpg" width="199" height="151" alt="Блог fashion-редактора" title="Блог fashion-редактора" /></a></div>
                            <div style="margin:14px 0 0 0;"><a href="/fitting-room/" onclick="javascript:window.open('/fitting-room/','fittingroom','width=920,height=675,toolbar=0,location=0,directories=0,menubar=0,scrollbars=0,resizable=0,status=0,fullscreen=0'); return false;"><img src="/images/mainpage_blocks/fitting_room.jpg" width="199" height="150" alt="Виртуальная примерочная" title="Виртуальная примерочная" /></a></div>
                        </td>
                        <td style="padding:0 16px;" valign="top"><div><img src="/images/i_trust.jpg" width="512" height="56" /></div><div>
							<script type="text/javascript" src="/swfobject/swfobject.js"></script>
                            <script type="text/javascript">
                                var attributes = {id:"Rotator", name:"Rotator"};
                                var flashvars = {};
                            	swfobject.embedSWF("/rotate_ss11.swf", "flashCont", 512, 424, "10", "/swfobject/expressinstall.swf", flashvars, {menu: 'false'}, attributes);
                            </script>
                            <style>
								#flashCont {
									width: 100%;
                            ...
                            <div id="flashCont">
                                <img src="/images/new_faces/kovalchuk.jpg" width="512" height="424" />
                            </div></div></td>
                        <td style="width:237px;" valign="top">
                            <div><a href="/about/news/?ELEMENT_ID=2163"><img src="/images/mainpage_blocks/belskih.jpg" width="237" height="150" alt="Лимитированная коллекция &laquo;Сны о лете&raquo;" title="Лимитированная коллекция &laquo;Сны о лете&raquo;" /></a></div>
                        	<div style="margin:15px 0 0 0;"><a href="/actions/2167/"><img src="/images/mainpage_blocks/skidka25verhod.jpg" width="237" height="150" alt="Скидка 25% на весеннюю коллекцию верхней одежды" title="Скидка 25% на весеннюю коллекцию верхней одежды" /></a></div>
                        	<div style="margin:15px 0 0 0;"><a href="/actions/2160/"><img src="/images/mainpage_blocks/golovokruzhitelno_small.jpg" width="237" height="150" alt="Головокружительный шопинг" title="Головокружительный шопинг" /></a></div>
                    ...
                    <tr>
                        ...
                        <td valign="top" style="padding:31px 0 0 0; text-align:left;">
                        	<div style="padding:8px 0 7px 13px;"><img src="/images/headers/partner_programs.jpg" width="212" height="12" alt="Партнёрские программы" title="Партнёрские программы" /></div>
                            <div style="height:4px; background:url(/images/headers/header_underline.gif) repeat-x; width:100%;"></div>
	                        <div style="padding:7px 0 7px 0;">
                            	<div><a href="/card_snowqueen/"><img src="/images/card_snowqueen.jpg" width="237" height="149" alt="Снежная Королева" title="Снежная Королева" /></a></div>
                                <div style="padding:3px 0 0 10px;"><a href="/card_snowqueen/">Снежная Королева</a></div>
                                <div style="padding:20px 0 0 10px;"><a href="/sclub/">Связной-Клуб</a></div>
                                <div style="padding:5px 0 10px 10px;"><a href="/zenit/">Зенит</a></div>
                            </div>
