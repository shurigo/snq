            	...
            	<table style="width:100%;">
                	<tr>
                        ...
                        <td style="width:237px;" valign="top">
                        	<div><a href="/actions/1057/"><img src="/images/mainpage_blocks/valentine_day.jpg" width="237" height="232" alt="С Днем Святого Валентина!" title="С Днем Святого Валентина!" /></a></div>
                            <div style="margin:16px 0 0 0;"><a href="/actions/1054/"><img src="/images/mainpage_blocks/sale70_med.jpg" width="237" height="232" alt="В «СНЕЖНОЙ КОРОЛЕВЕ» СКИДКИ - 70% НА ВСЕ!" title="В «СНЕЖНОЙ КОРОЛЕВЕ» СКИДКИ - 70% НА ВСЕ!" /></a></div>
                        </td>
                    </tr>
                    <tr>
