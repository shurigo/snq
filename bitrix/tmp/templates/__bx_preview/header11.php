            	...
            	<table style="width:100%;">
                	<tr>
                        ...
                        <td style="padding:0 16px;" valign="top"><div><img src="/images/mainpage_blocks/style.jpg" width="512" height="56" /></div><div>
                            ...
                            <div id="flashCont">
                                <img src="/images/mainpagebanpics/newyear1.jpg" width="512" height="424" />
                            </div>
                      </div></td>
                        <td style="width:237px;" valign="top">
                        	<div><a href="/actions/1042/"><img src="/images/mainpage_blocks/ny_discount_small.jpg" width="237" height="232" alt="В «СНЕЖНОЙ КОРОЛЕВЕ» СКИДКИ - 30% НА ВСЕ!" title="В «СНЕЖНОЙ КОРОЛЕВЕ» СКИДКИ - 30% НА ВСЕ!" /></a></div>
                            <div style="margin:16px 0 0 0;"><a href="/actions/1043/"><img src="/images/mainpage_blocks/buy_more.jpg" width="237" height="232" alt="КУПИ БОЛЬШЕ – ПЛАТИ МЕНЬШЕ!" title="КУПИ БОЛЬШЕ – ПЛАТИ МЕНЬШЕ!" /></a></div>
                        </td>
                    </tr>
                    <tr>
