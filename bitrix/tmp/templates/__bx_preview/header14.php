            	...
            	<table style="width:100%;">
                	<tr>
                        ...
                        <td style="width:237px;" valign="top">
                            <div id="flashContent">
                                <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="237" height="232" id="goodprice237x232" align="middle">
                                    <param name="movie" value="goodprice237x232.swf?link=/actions/1059/" />
                                    ...
                                    <!--[if !IE]>-->
                                    <object type="application/x-shockwave-flash" data="goodprice237x232.swf?link=/actions/1059/" width="237" height="232">
                                        <param name="movie" value="goodprice237x232.swf" />
                                        <param name="quality" value="high" />
                                        <param name="bgcolor" value="#ffffff" />
                                        <param name="play" value="true" />
                                        <param name="loop" value="true" />
