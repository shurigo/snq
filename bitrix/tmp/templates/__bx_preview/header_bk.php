        ...
        <td style="width:980px;">
        	<div style="width:980px;">
            	<table style="width:980px;">
                	<tr>
                    	<td style="padding:10px 0 0 0;" valign="top"><img src="/images/logo.jpg" width="444" height="89" alt="Снежная королева" title="Снежная королева" /></td>
            ...
            <table style="width:100%;">
            	<tr>
                	<td style="width:190px;"><a href="/collection/wfurs_aw10_11/"><img src="/images/catalog_menu/furs_collection.jpg" width="190" height="37" alt="Коллекция мехов" title="Коллекция мехов" /></a></td>
                    <td style="width:25%;"></td>
                    <td style="width:190px;"><a href="/collection/wskincoat_aw10_11/"><img src="/images/catalog_menu/sheepskin_coats.jpg" width="190" height="37" alt="Модные дублёнки" title="Модные дублёнки" /></a></td>
                    <td style="width:25%;"></td>
                    <td style="width:190px;"><a href="/collection/wleather_aw10_11/"><img src="/images/catalog_menu/leather_clothes.jpg" width="190" height="37" alt="Одежда из кожи" title="Одежда из кожи" /></a></td>
                    <td style="width:25%;"></td>
                    <td style="width:190px;"><a href="/collection/wclothes_aw10_11/"><img src="/images/catalog_menu/textile_clothes.jpg" width="190" height="37" alt="Одежда из текстиля" title="Одежда из текстиля" /></a></td>
                    <td style="width:25%;"></td>
                    <td style="width:190px;"><a href="/collection/waccess_aw10_11/"><img src="/images/catalog_menu/accessories.jpg" width="190" height="37" alt="Сумки и аксессуары" title="Сумки и аксессуары" /></a></td>
                </tr>
            </table>
            </div>
                	...
                	<tr>
                    	<td style="width:199px;" valign="top">
                        	<div style="width:199px; height:162px; background:url(/images/mainpage_blocks/download_catalog.jpg) no-repeat;">
                                ...
                                <div style="width:199px; height:52px; padding:10px 0 0 0px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/upload/SnowQueen_Autumn2010.pdf" style="font-weight:bold;" class="snq_color">Скачать каталог</a><br />
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PDF, Объём: 6,73 Mb</div>
                            </div>
                            <div style="margin:15px 0 0 0;"><a href="/good_prices/"><img src="/images/mainpage_blocks/new_collection.jpg" width="199" height="162" alt="Новая коллекция" title="Новая коллекция"  /></a></div>
                            <div style="margin:15px 0 0 0;"><img src="/images/mainpage_blocks/fitting_room.jpg" width="199" height="162" alt="Виртуальная примерочная" title="Виртуальная примерочная" /></div>
                        </td>
                        <td style="padding:0 16px;" valign="top"><img src="/images/mainpage_blocks/cristina.jpg" width="512" height="516" alt="Стильно - не значит дорого" title="Стильно - не значит дорого" /></td>
                        <td style="width:237px;" valign="top">
                        	<div><a href="/collection/"><img src="/images/mainpage_blocks/new_collection_big.jpg" width="237" height="516" alt="Новая коллекция" title="Новая коллекция" /></a></div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td valign="top" style="padding:31px 0 0 0; text-align:center;"><a href="/sclub/"><img src="/images/sclub.jpg" width="237" height="316" alt="Связной-Клуб" title="Связной-Клуб" /></a></td>
                    </tr>
                </table>
            </div>
