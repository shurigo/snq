            	...
            	<table style="width:100%;">
                	<tr>
                        ...
                        <td style="width:237px;" valign="top">
                        	<div><a href="/actions/1028/"><img src="/images/mainpage_blocks/buyweeks011010.jpg" width="237" height="150" alt="С 27 СЕНТЯБРЯ ПО 10 ОКТЯБРЯ - «НЕДЕЛИ УДАЧНЫХ ПОКУПОК» в «СНЕЖНОЙ КОРОЛЕВЕ»!" title="С 27 СЕНТЯБРЯ ПО 10 ОКТЯБРЯ - «НЕДЕЛИ УДАЧНЫХ ПОКУПОК» в «СНЕЖНОЙ КОРОЛЕВЕ»!" /></a></div>
                            <div style="margin:15px 0 0 0;"><a href="/actions/1029/"><img src="/images/mainpage_blocks/vip_karta.jpg" width="237" height="150" alt="Дисконтная карта VIP – 15% в подарок каждому покупателю шубы в магазинах «Снежная Королева»" title="Дисконтная карта VIP – 15% в подарок каждому покупателю шубы в магазинах «Снежная Королева»" /></a></div>
                            <div style="margin:15px 0 0 0;"><a href="/actions/1030/"><img src="/images/mainpage_blocks/skincoat.jpg" width="237" height="150" alt="20% ДУБЛЁНКИ В ПОДАРОК" title="20% ДУБЛЁНКИ В ПОДАРОК" /></a></div>
                        </td>
                    </tr>
                    <tr>
