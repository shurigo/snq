				...
				switch (func.name)
				{
					case 'ShowInput': 
						...
						if (element_index !== false)
						{
							...
							var funcparams = [{name:'element_index', value:element_index}];

							var __bxcontainer_value = BXSerialize(funcparams);
							__bxcontainer_value = __bxcontainer_value.replace(/"/g, "&quot;"); //"
		
							var funcstr = '<img src="/bitrix/images/form/visual/form_edit_' + __q_obj.type + '.gif" __bxtagname="form_question" __bxcontainer="' + __bxcontainer_value + '" border="0" />';
					...
					default:
						...
						var funcparams = [];
						funcparams[0] = {name:'METHOD', value:func.name};
						funcparams[1] = {name:'INDEX', value:_index};
						...
						{
							var funcstr = '<img src="/bitrix/images/form/visual/form_api_edit_' + func.name.toLowerCase() + '.gif" __bxtagname="form_api" __bxcontainer="' + __bxcontainer_value + '" border="0" />';
						}
						else
						{
							var funcstr = '<img src="/bitrix/images/form/visual/form_api_' + func.name.toLowerCase() + '.gif" __bxtagname="form_api" __bxcontainer="' + __bxcontainer_value + '" border="0" />';
						}
