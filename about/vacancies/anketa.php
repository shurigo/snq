...
<fieldset>
<table>
<tr><td width="30%">Фамилия:*</td><td width="70%"><input type="text"   name="last_name" size="40" maxlength="40"></td></tr>
<tr><td width="30%">Имя:*</td><td width="70%"><input type="text"   name="first_name" size="40" maxlength="40"></td></tr>
<tr><td width="30%">Отчество:*</td><td width="70%"><input type="text"   name="middle_name" size="40" maxlength="40"></td></tr>
<tr><td width="30%">Дата рождения:*</td><td width="70%"><input type="text"   name="middle_name" size="40" maxlength="40"></td></tr>
<tr><td width="30%">Гражданство:*</td><td width="70%"><input type="text"   name="middle_name" size="40" maxlength="40"></td></tr>
<tr><td width="30%">Адрес фактического проживания:</td><td width="70%"><input type="text"   name="middle_name" size="40" maxlength="40"></td></tr>
<tr><td width="30%">Контактные телефоны:*</td><td width="70%">мобильный:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;+7<input type="text"   name="mobile_phone" size="10" maxlength="40"><br /><br />&nbsp;или домашний: +7<input type="text"   name="home_phone" size="10" maxlength="40"></td></tr>
...
<tr><td width="30%" align="right">название компании:</td><td width="70%"><input type="text"   name="company_name" size="40" maxlength="40"></td></tr>
<tr><td width="30%" align="right">должность:</td><td width="70%"><input type="text"   name="job" size="40" maxlength="40"></td></tr>
<tr><td width="30%" align="right">должносные обязанности:</td><td width="70%"><textarea  name="duties" cols="42" rows="5"></textarea></td></tr>
...
<tr><td width="30%">Заинтересовавшая анкета</td><td width="70%"><input type="text" name="vacancy" size="40" maxlength="40" value="<?=$vacancy_name?>" disabled></td></tr>
<tr><td width="30%">Как вы узнали о вакансии:</td><td width="70%"><input type="text"  name="info" size="40" maxlength="40"></td></tr>
<tr><td width="30%">Здесь вы можите прикрепить свое резюме:</td><td width="70%"><input type="file"  name="cv" size="40" maxlength="40"></td></tr>
</table>
<div class="form_name">Введите код с картинки в поле ниже:</div> <?="test=".$code?>
