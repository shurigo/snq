            ...
            <div style="margin:10px 0 0 0;">
            	<table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td valign="top" style="padding:57px 0 0 0; text-align:left;"><div><a href="/sclub/"><img src="/images/svyaznoy.jpg" width="195" height="216" alt="Связной-Клуб" title="Связной-Клуб" style="border:1px solid #9B9B9B;" /></a></div>
							<div style="margin:20px 0 0 0;"><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="snowqueen.ru" show_faces="false" width="150" font="verdana"></fb:like></div>
                            <div style="margin:20px 0 0 0;"><div id="vk_like"></div>
                                <script type="text/javascript">
