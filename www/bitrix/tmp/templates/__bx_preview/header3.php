            	...
            	<table style="width:100%;">
                	<tr>
                    	<td style="width:199px;" valign="top">
                            ...
                            <div style="margin:15px 0 0 0;"><a href="/good_prices/"><img src="/images/mainpage_blocks/new_collection.jpg" width="199" height="150" alt="Новая коллекция" title="Новая коллекция"  /></a></div>
                            <div style="margin:15px 0 0 0;"><img src="/images/mainpage_blocks/fitting_room.jpg" width="199" height="150" alt="Виртуальная примерочная" title="Виртуальная примерочная" /></div>
                        </td>
                        <td style="padding:0 16px;" valign="top"><div><img src="/images/mainpage_blocks/style.jpg" width="512" height="56" /></div><div>
                          <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="512" height="424">
                            <param name="movie" value="/images/snowqueen.swf" />
                            ...
                            <!--[if !IE]>-->
                            <object type="application/x-shockwave-flash" data="/images/snowqueen.swf" width="512" height="424">
                              <!--<![endif]-->
                              <param name="quality" value="high" />
                              <param name="wmode" value="opaque" />
                              <param name="swfversion" value="6.0.65.0" />
                        ...
                        <td style="width:237px;" valign="top">
                        	<div><a href="/collection/"><img src="/images/mainpage_blocks/new_collection_big.jpg" width="237" height="232" alt="Новая коллекция" title="Новая коллекция" /></a></div>
                            <div style="margin:15px 0 0 0;"><a href="/actions/1010/"><img src="/images/mainpage_blocks/buyweeks.jpg" width="237" height="233" alt="С 13 ПО 26 СЕНТЯБРЯ - «НЕДЕЛИ УДАЧНЫХ ПОКУПОК» в «СНЕЖНОЙ КОРОЛЕВЕ»!" title="С 13 ПО 26 СЕНТЯБРЯ - «НЕДЕЛИ УДАЧНЫХ ПОКУПОК» в «СНЕЖНОЙ КОРОЛЕВЕ»!" /></a></div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td valign="top" style="padding:31px 0 0 0; text-align:center;"><img src="/images/svyaznoy.jpg" width="195" height="216" alt="Связной-Клуб" title="Связной-Клуб" style="border:1px solid #9B9B9B;" /></td>
                    </tr>
                </table>
            </div>        
