            	...
            	<table style="width:100%;">
                	<tr>
                        ...
                        <td style="width:237px;" valign="top">
                        	<div><a href="/actions/1042/"><img src="/images/mainpage_blocks/ny_discount_small.jpg" width="237" height="150" alt="В «СНЕЖНОЙ КОРОЛЕВЕ» СКИДКИ - 30% НА ВСЕ!" title="В «СНЕЖНОЙ КОРОЛЕВЕ» СКИДКИ - 30% НА ВСЕ!" /></a></div>
                            <div style="margin:15px 0 0 0;"><a href="/actions/1043/"><img src="/images/mainpage_blocks/buy_more.jpg" width="237" height="150" alt="КУПИ БОЛЬШЕ – ПЛАТИ МЕНЬШЕ!" title="КУПИ БОЛЬШЕ – ПЛАТИ МЕНЬШЕ!" /></a></div>
