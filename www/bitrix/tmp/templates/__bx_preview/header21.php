            	...
            	<table style="width:100%;">
                	<tr>
                    	<td style="width:199px;" valign="top">
                            ...
                            <div style="margin:15px 0 0 0;"><a href="/fitting-room/" onclick="javascript:window.open('/fitting-room/','fittingroom','width=920,height=675,toolbar=0,location=0,directories=0,menubar=0,scrollbars=0,resizable=0,status=0,fullscreen=0'); return false;"><img src="/images/mainpage_blocks/fitting_room_long_2.jpg" width="199" height="315" alt="Виртуальная примерочная скоро на нашем сайте" title="Виртуальная примерочная скоро на нашем сайте" /></a></div>
                        </td>
                        ...
                        <td style="width:237px;" valign="top">
                        	<div><a href="/actions/2160/"><img src="/images/mainpage_blocks/golovokruzhitelno.jpg" width="237" height="150" alt="Головокружительный шопинг" title="Головокружительный шопинг" /></a></div>
                            ...
                            <div style="margin:15px 0 0 0;"><a href="/actions/1784/"><img src="/images/mainpage_blocks/march8_small.jpg" width="237" height="150" alt="БОЛЬШЕ ОБНОВОК – БОЛЬШЕ ЭКОНОМИЯ!" title="БОЛЬШЕ ОБНОВОК – БОЛЬШЕ ЭКОНОМИЯ!" /></a></div>
                      </td>
                    </tr>
                    <tr>
