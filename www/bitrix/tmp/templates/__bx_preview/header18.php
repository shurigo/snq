            	...
            	<table style="width:100%;">
                	<tr>
                    	<td style="width:199px;" valign="top">
                            ...
                            <div style="margin:15px 0 0 0;"><img src="/images/mainpage_blocks/fitting_room_long.jpg" width="199" height="315" alt="Виртуальная примерочная скоро на нашем сайте" title="Виртуальная примерочная скоро на нашем сайте" /></div>
                        </td>
                        ...
                        <td style="width:237px;" valign="top">
                        	<div><a href="/actions/2159/"><img src="/images/mainpage_blocks/podarok8marta.jpg" width="237" height="150" alt="При покупке сумки – платок в подарок!" title="При покупке сумки – платок в подарок!" /></a></div>
