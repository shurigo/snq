            	...
            	<table style="width:100%;">
                	<tr>
                        ...
                        <td style="width:237px;" valign="top">
                            ...
                            <div style="margin:15px 0 0 0;"><a href="/actions/1784/"><img src="/images/march8.jpg" width="237" height="233" alt="" title="" /></a></div>
                      </td>
                    </tr>
                    <tr>
                        ...
                        <td valign="top" style="padding:31px 0 0 0; text-align:left;">
                        	<div style="padding:10px 0 7px 13px;"><img src="/images/headers/partner_programs.jpg" width="212" height="12" alt="Партнёрские программы" title="Партнёрские программы" /></div>
                            <div style="height:4px; background:url(/images/headers/header_underline.gif) repeat-x; width:100%;"></div>
