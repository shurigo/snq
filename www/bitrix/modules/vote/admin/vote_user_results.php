...
<input type="hidden" name="lang" value="<?=LANGUAGE_ID?>">
	...
	<tr>
		...
		if (strlen($arVote["TITLE"])>0) echo htmlspecialchars($arVote["TITLE"]);
		elseif ($arVote["DESCRIPTION_TYPE"]=="html")
			echo htmlspecialchars(TruncateText(strip_tags($arVote["DESCRIPTION"]),200));
		else
			echo htmlspecialchars(TruncateText($arVote["DESCRIPTION"],200));
		?></font></td>
	</tr>
	<tr>
		<td  ><?=GetMessage("VOTE_CHANNEL")?></b></font></td>
		<td ><?="[<a class='tablebodylink' href='vote_channel_edit.php?ID=".$arChannel["ID"]."&lang=".LANGUAGE_ID."'>".$arChannel["ID"]."</a>] ".htmlspecialchars($arChannel["TITLE"])?></font></td>
	</tr>
	<tr>
