...
else
{
	...
	foreach ($_REQUEST["ANSWER"] as $pid)
	{
		...
		$arAnswer = array(
			...
			"QUESTION_ID" => $ID, 
			"ACTIVE" => $_REQUEST["ACTIVE_".$pid], 
			"C_SORT" => $_REQUEST["C_SORT_".$pid], 
			"MESSAGE" => trim($_REQUEST["MESSAGE_".$pid]), 
...
?>
	...
	<tr>
		<td width=40%><span class="required">*</span><?=GetMessage('VOTE_QUESTION_TEXT_FIELD')?></td>
		<td width=60%></td>
	</tr>
	<?
	...
	<tr>
		<td align="center" colspan="2"><?
			CFileMan::AddHTMLEditorFrame("QUESTION", $arQuestion["QUESTION"], "QUESTION_TYPE", $arQuestion["QUESTION_TYPE"], 200);
		?></td>
	</tr>
	<?else:?>
	<tr>
