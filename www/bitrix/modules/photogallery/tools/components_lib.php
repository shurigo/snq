		...
		if (empty($arResult[$arCache["id"]]))
		{
			...
			else
			{
				...
				$db_res = CIBlockSection::GetList(
					...
					$arFilter, 
					false, 
					array("ID", "ACTIVE", "CODE", "NAME", "CREATED_BY", "RIGHT_MARGIN", "LEFT_MARGIN"));
		...
		if (empty($arResult[$arCache["id"]]))
		{
			...
			else 
			{
				...
				$db_res = CIBlockSection::GetList(
					...
					$arFilter, 
					false, 
					array("ID", "CODE", "NAME", "ACTIVE", "SECTION_ID", "RIGHT_MARGIN", "LEFT_MARGIN"));
		...
		if (!empty($arSection) && ($arSection["LEFT_MARGIN"] < $arGallery["LEFT_MARGIN"] || $arGallery["RIGHT_MARGIN"] < $arSection["RIGHT_MARGIN"]))
		{
			...
			$db_res = CIBlockSection::GetList(
				...
				array(
					...
					"!ID" => $arSection["ID"]), 
				false, 
				array("ID", "CODE", "NAME", "CREATED_BY", "RIGHT_MARGIN", "LEFT_MARGIN"));
