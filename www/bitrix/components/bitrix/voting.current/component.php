...
if ($GLOBALS["VOTING_OK"] == "Y" && !empty($arParams["VOTE_RESULT_TEMPLATE"]))
{
	...
	LocalRedirect($url."&VOTE_SUCCESSFULL=Y".$strNavQueryString);
}
elseif ($GLOBALS["VOTING_OK"] =="Y" || $GLOBALS["USER_ALREADY_VOTE"] =="Y" || $permission == 1 || $isUserVoted || 
	$_REQUEST["view_result"] == "Y" || $_REQUEST["VOTE_SUCCESSFULL"] == "Y")
