...
$arParams["LEFT_MENU_FLAG"] = intval($arParams["LEFT_MENU_FLAG"]);
...
if($this->StartResultCache(false, ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups())))
{
	...
	if ($arParams["LEFT_MENU_FLAG"] == 1)
	{
		$arResult["NAV_SECTION_ARRAY"] = array();
		$dbSectionNav = CIBlockSection::GetNavChain($arParams["IBLOCK_ID"], $arParams["SECTION_ID"]);
		while($arSectionNav = $dbSectionNav->GetNext())
		{
...
if(count($arResult["SECTIONS"])>0 || isset($arResult["SECTION"]))
{
	...
	if($arParams["ADD_SECTIONS_CHAIN"] && isset($arResult["SECTION"]) && is_array($arResult["SECTION"]["PATH"]) && !$arParams["LEFT_MENU_FLAG"])
	{
