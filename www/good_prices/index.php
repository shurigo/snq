...
$APPLICATION->SetTitle("Специальные цены");
?>
<div> 
  <table style="width: 100%;"> 
    <tbody> 
      <tr> <td valign="top" style="width: auto; padding: 10px 29px 0pt 16px;"> 
			<h1>Специальные цены на модели из новой коллекции!</h1>
          <p> <?$APPLICATION->IncludeComponent("bitrix:catalog.section", "good_price", Array(
                "AJAX_MODE" => "N",	// Включить режим AJAX
                "IBLOCK_TYPE" => "collection",	// Тип инфо-блока
                "IBLOCK_ID" => "1",	// Инфо-блок
                "SECTION_ID" => "173",	// ID раздела
                "SECTION_CODE" => "special_price",	// Код раздела
