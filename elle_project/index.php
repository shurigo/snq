    ...
    <div class="main_div page1">
        ...
        <div class="position_relative">
        	<div class="position_absolute main_menu">
            	<div id="menu1">Очарование ретро</div>
        ...
        <div class="position_relative">
        	<div class="position_absolute previuos_page" onclick="javascript:location.href='page5.php'">
            </div>
        </div>
        <div class="position_relative">
        	<div class="position_absolute next_page" onclick="javascript:location.href='page2.php'">
            </div>
        </div>
