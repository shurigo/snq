    ...
    <div class="main_div page2">
        ...
        <div class="position_relative">
        	<div class="position_absolute main_menu">
                ...
                <div id="menu2">Роковой соблазн</div>
        ...
        <div class="position_relative">
        	<div class="position_absolute previuos_page" onclick="javascript:location.href='index.php'">
            </div>
        </div>
        <div class="position_relative">
        	<div class="position_absolute next_page" onclick="javascript:location.href='page3.php'">
            </div>
        </div>
