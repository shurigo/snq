    ...
    <div class="main_div page5">
        ...
        <div class="position_relative">
        	<div class="position_absolute main_menu">
                ...
                <div id="menu5">Поющая под дождем</div>
            </div>
        </div>
        <div class="position_relative">
        	<div class="position_absolute previuos_page" onclick="javascript:location.href='page4.php'">
            </div>
        </div>
        <div class="position_relative">
        	<div class="position_absolute next_page" onclick="javascript:location.href='index.php'">
            </div>
        </div>
