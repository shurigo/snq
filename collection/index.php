  ...
  require($_SERVER["DOCUMENT_ROOT"]."/bitrix/header.php");
	...
	$APPLICATION->IncludeComponent(
		...
		Array(
			...
			"LIST_PROPERTY_CODE" => array(0=>"col_idmfc",1=>"col_price",2=>"col_sizes",3=>"col_brand",4=>"col_price_origin",5=>"add_pic_1",6=>"add_pic_2",7=>"add_pic_3",8=>"add_pic_4",9=>"col_add_discount"),
