  ...
  require($_SERVER["DOCUMENT_ROOT"]."/bitrix/header.php");
	...
	$APPLICATION->IncludeComponent(
		...
		Array(
			...
			"LIST_PROPERTY_CODE" => array(0=>"col_model_code",1=>"col_price",2=>"col_sizes",3=>"col_brand",4=>"col_price_origin",5=>"add_pic_1",6=>"add_pic_2",7=>"add_pic_3",8=>"add_pic_4"),
			"INCLUDE_SUBSECTIONS" => "Y",
			"LIST_META_KEYWORDS" => "UF_SEC_KEYWORDS",
			"LIST_META_DESCRIPTION" => "UF_SEC_DESCRIPTON",
			"LIST_BROWSER_TITLE" => "UF_SEC_TITLE",
			"DETAIL_PROPERTY_CODE" => array(0=>"col_model_code",1=>"col_price",2=>"col_sizes",3=>"col_brand",4=>"col_price_origin",5=>"add_pic_1",6=>"add_pic_2",7=>"add_pic_3",8=>"add_pic_4",9=>"col_im_link"),
