...
?><?$APPLICATION->IncludeComponent("bitrix:catalog", "collection", Array(
	...
	"LIST_META_KEYWORDS" => "UF_SEC_KEYWORDS",	// Установить ключевые слова страницы из свойства раздела
	"LIST_META_DESCRIPTION" => "UF_SEC_DESCRIPTON",	// Установить описание страницы из свойства раздела
	...
	"DETAIL_META_KEYWORDS" => "col_keywords",	// Установить ключевые слова страницы из свойства
	"DETAIL_META_DESCRIPTION" => "col_description",	// Установить описание страницы из свойства
	"DETAIL_BROWSER_TITLE" => "col_title",	// Установить заголовок окна браузера из свойства
	...
	"ELEMENT_SORT_FIELD_BOX" => "id",	// По какому полю сортируем список элементов
